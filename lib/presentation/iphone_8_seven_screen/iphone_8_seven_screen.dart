...
class Iphone8SevenScreen extends StatelessWidget {
  const Iphone8SevenScreen({Key? key})
      : super(
          key: key,
        );
            ...
            children: [
              ...
              Container(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "Inputkan Suhu Celcius"
                ),
              ),
              ),
              ...
              CustomElevatedButton(
                ...
                text: "Konversi",
                onPressed: (){
                  if(inputCelcius.text == ""){
                      Fluttertoast.showToast(
                        msg: "Masukkan Suhu Celcius",
                    ...
                    num c = num.parse(inputCelcius.text);
                    num f, r, k, ran;
                    f = (9/5 * c) + 32;
                    r = 4/5 * c;
                    k = c + 273.15;
