...
class Iphone8EightScreen extends StatelessWidget {
  const Iphone8EightScreen({Key? key})
      : super(
          key: key,
        );
            ...
            children: [
              ...
              Container(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: "Inputkan Suhu Reaumur"
                ),
              ),
              ),
              ...
              CustomElevatedButton(
                ...
                text: "Konversi",
                onPressed: (){
                  if(inputReaumur.text == ""){
                      Fluttertoast.showToast(
                        msg: "Masukkan Suhu Reumur",
                    ...
                    num r = num.parse(inputReaumur.text);
                    num f, c, k, ran;
                    f = (9/4 * r) + 32;
                    c = 5/4 * r;
                    k = (5/4 * r) + 273.15;
                    ran = (r * 2.25) + 32 + 459.67;
